...
public class LCNetExperimenter {
	...
	public static void main(String[] args) {
		...
		ExperimentRunner experimentRunner = new ExperimentRunner(new IExperimentSetEvaluator() {
			...
			public void evaluate(ExperimentDBEntry experimentEntry, SQLAdapter adapter,
				...
				int seed = Integer.valueOf(valuesOfKeyFields.get("seed"));
				Random random = new Random();
				
				double datasetSize = Double.valueOf(valuesOfKeyFields.get("datasetSize"));
				
				String dataset = valuesOfKeyFields.get("dataset");
